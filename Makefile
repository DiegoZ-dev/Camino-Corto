OBJS	= main1.o main2.o planificador.o colacp.o
SOURCE	= ./Proyecto/colacp.c ./Proyecto/planificador.c, ./TP1/main1.c, ./TP2/main2.c
HEADER	= ./Proyecto/colacp.h ./Proyecto/listadoble.h ./Proyecto/constantes.h
OUT	= proyecto tp1 tp2
